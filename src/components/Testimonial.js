...
import gambar1 from "../../src/images/photo1.svg"
import gambar2 from "../../src/images/photo2.svg"
                ...
                >
                    ...
                    <div className="carousel-item active">
                        ...
                        <div className="card-body d-lg-flex">
                            <img src={gambar1} className="card-img-top" alt="..." height="200" />
                    ...
                    <div className="carousel-item">
                        <div className="card">
                        <div className="card-body d-lg-flex">
                            <img src={gambar2} className="card-img-top" alt="..." height="200" />
                            <div className="card-body align-self-center">
                                <img src={star} alt=""/>
                                <img src={star} alt=""/>
                                <img src={star} alt=""/>
